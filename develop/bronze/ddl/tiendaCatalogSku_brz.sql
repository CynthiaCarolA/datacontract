-- Data Contract: urn:datacontract:develop:tiendaCatalogSku_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE develop.bronze.tiendaCatalogSku_brz (
...
ALTER TABLE develop.bronze.tiendaCatalogSku_brz SET TAGS ('Domain'='develop', 'Schema'='bronze', 'TypeTable'='raw');
