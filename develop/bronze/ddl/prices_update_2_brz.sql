-- Data Contract: urn:datacontract:develop:prices_update_2_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE develop.bronze.prices_update_2_brz (
...
ALTER TABLE develop.bronze.prices_update_2_brz SET TAGS ('Domain'='develop', 'Schema'='bronze', 'TypeTable'='raw');
ALTER TABLE develop.bronze.prices_update_2_brz ALTER COLUMN basePrice SET TAGS ('dac');
