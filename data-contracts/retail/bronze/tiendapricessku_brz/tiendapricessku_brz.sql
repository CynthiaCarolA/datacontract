...
-- COMMAND ----------
-- Data Contract: urn:datacontract:retail:tiendaPricesSku_brz-latest
...
ALTER TABLE retail.bronze.tiendaPricesSku_brz SET TAGS ('Domain'='retail', 'Schema'='bronze', 'TypeTable'='raw');
