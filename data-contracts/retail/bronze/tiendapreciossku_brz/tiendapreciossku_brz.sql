-- Data Contract: urn:datacontract:retail:tiendaPreciosSku_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE retail.bronze.tiendaPreciosSku_brz (
...
ALTER TABLE retail.bronze.tiendaPreciosSku_brz SET TAGS ('Domain'='retail', 'Schema'='bronze', 'TypeTable'='raw');
ALTER TABLE retail.bronze.tiendaPreciosSku_brz ALTER COLUMN itemId SET TAGS ('dac');
ALTER TABLE retail.bronze.tiendaPreciosSku_brz ALTER COLUMN basePrice SET TAGS ('dac');
