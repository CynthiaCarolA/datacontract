-- Data Contract: urn:datacontract:develop:pricing_prices_update_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE develop.bronze.pricing_prices_update_brz (
...
ALTER TABLE develop.bronze.pricing_prices_update_brz SET TAGS ('Domain'='develop', 'Schema'='bronze', 'TypeTable'='raw');
ALTER TABLE develop.bronze.pricing_prices_update_brz ALTER COLUMN itemId SET TAGS ('dac');
ALTER TABLE develop.bronze.pricing_prices_update_brz ALTER COLUMN basePrice SET TAGS ('dac');
