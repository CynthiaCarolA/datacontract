-- Data Contract: urn:datacontract:develop:marketplace_order_created_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE develop.bronze.marketplace_order_created_brz (
...
ALTER TABLE develop.bronze.marketplace_order_created_brz SET TAGS ('Domain'='develop', 'Schema'='bronze', 'TypeTable'='raw');
