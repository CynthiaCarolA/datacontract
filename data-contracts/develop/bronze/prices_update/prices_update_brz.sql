...
ALTER TABLE develop.bronze.prices_update_brz ALTER COLUMN itemId SET TAGS ('dac');
ALTER TABLE develop.bronze.prices_update_brz ALTER COLUMN basePrice SET TAGS ('dac');
