-- Data Contract: urn:datacontract:develop:created_order_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE develop.bronze.created_order_brz (
...
ALTER TABLE develop.bronze.created_order_brz SET TAGS ('Domain'='develop', 'Schema'='bronze', 'TypeTable'='raw');
