-- Data Contract: urn:datacontract:develop:created_order_y_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE develop.bronze.created_order_y_brz (
...
ALTER TABLE develop.bronze.created_order_y_brz SET TAGS ('Domain'='develop', 'Schema'='bronze', 'TypeTable'='raw');
