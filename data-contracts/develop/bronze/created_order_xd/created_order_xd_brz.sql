-- Data Contract: urn:datacontract:develop:created_order_xd_brz-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE develop.bronze.created_order_xd_brz (
...
ALTER TABLE develop.bronze.created_order_xd_brz SET TAGS ('Domain'='develop', 'Schema'='bronze', 'TypeTable'='raw');
