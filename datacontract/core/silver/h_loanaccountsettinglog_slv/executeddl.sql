...
-- Data Contract: urn:${env:ENV_CATALOG_NAME_CORE}.silver.h_loanaccountsettinglog_slv-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE ${env:ENV_CATALOG_NAME_CORE}.silver.h_loanaccountsettinglog_slv (
  ...
  ,CONSTRAINT h_loanaccountsettinglog_slv_accountSettingId_fk FOREIGN KEY (accountSettingId) REFERENCES ${env:ENV_CATALOG_NAME_CORE}.silver.m_accountsetting_slv.accountSettingId
  ,CONSTRAINT h_loanaccountsettinglog_slv_accountId_fk FOREIGN KEY (accountId) REFERENCES ${env:ENV_CATALOG_NAME_CORE}.silver.m_account_slv.accountId
)
...
ALTER TABLE ${env:ENV_CATALOG_NAME_CORE}.silver.h_loanaccountsettinglog_slv SET TAGS ('TypeTable'='historical');
