...
CREATE OR REPLACE TABLE core.silver.h_loanaccountsettinglog_slv (
  ...
  ,CONSTRAINT h_loanaccountsettinglog_slv_accountSettingId_fk FOREIGN KEY (accountSettingId) REFERENCES core.silver.m_accountsetting_slv.accountSettingId
  ,CONSTRAINT h_loanaccountsettinglog_slv_accountId_fk FOREIGN KEY (accountId) REFERENCES core.silver.m_account_slv.accountId
)
...
ALTER TABLE core.silver.h_loanaccountsettinglog_slv SET TAGS ('TypeTable'='historical');
