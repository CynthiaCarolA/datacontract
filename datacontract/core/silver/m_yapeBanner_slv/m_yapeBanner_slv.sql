...
-- COMMAND ----------
-- Data Contract: urn:core.silver.m_yapeBanner_slv-latest
-- SQL Dialect: databricks
CREATE OR REPLACE TABLE core.silver.m_yapeBanner_slv (
  ...
  ,CONSTRAINT m_yapeBanner_slv_pk PRIMARY KEY(yapeBannerId)
)
...
ALTER TABLE core.silver.m_yapeBanner_slv SET TAGS ('Domain'='core', 'Layer'='silver', 'TypeTable'='master');
ALTER TABLE core.silver.m_yapeBanner_slv ALTER COLUMN organizationPhoneNum SET TAGS ('dac');
